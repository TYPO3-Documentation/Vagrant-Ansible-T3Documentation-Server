# This is https://gist.github.com/dmsimard/cd706de198c85a8255f6
# modified by mb, 2016-04-08, 2016-04-108
        ...
        if type(data) == dict:
            for field in FIELDS:
                if field in data.keys() and data[field]:
                    ...
                    print(u"\n{0}: {1}".format(field, output.replace(u"\\n", u"\n")))

    def _format_output(self, output):
        # Strip unicode
        if 0 and type(output) == unicode:
